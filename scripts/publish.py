#!/usr/bin/env python3
"""
Script to help publish sqlstream to PyPI.
"""
...
def main():
    ...
    print(f"🚀 Publishing sqlstream v{new_version} to PyPI")
    print("=" * 60)
...
def test_upload():
    ...
    print(f"  pip install --index-url https://test.pypi.org/simple/ sqlstream=={new_version}")
